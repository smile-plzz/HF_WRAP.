...
export const POPULAR_MODELS: ModelOption[] = [
  { id: "mistralai/Mistral-7B-Instruct-v0.3", name: "Mistral 7B Instruct", type: "text", task: "text-generation", provider: "together" },
  { id: "google/gemma-2-2b-it", name: "Gemma 2 2B", type: "text", task: "text-generation", provider: "fireworks-ai" },
